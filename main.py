...
def main():
    ...
    # Temp grid
    for i in range(11):
        pg.draw.line(screen, (90, 90, 90), (animation_rectangle_width / 10 * i, 0), (animation_rectangle_width / 10 * i, animation_rectangle_height))
        pg.draw.line(screen, (90, 90, 90), (0, animation_rectangle_height / 10 * i), (animation_rectangle_width, animation_rectangle_height / 10 * i))
    ...
    while True:
        ...
        for i in range(POINTS_AMOUNT):
            ...
            amplitude = 0.1
            point = (x, wave_equation(x, amplitude, 1., 1., t))

            translated_point = (point[0] * 0.8 * animation_rectangle_width / 6.25 + 0.1 * animation_rectangle_width,
                                point[1] * 0.8 * animation_rectangle_height + 0.5 * animation_rectangle_height)
        ...
        pg.draw.lines(surface=screen, color=Colors.amp_orange, closed=False, points=points, width=2)
